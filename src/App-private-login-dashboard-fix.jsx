...
export default function App(){
  ...
  useEffect(()=>{
    ...
    supabase.auth.getSession().then(({data})=>setUser(data.session?.user||null)).finally(()=>setAuthReady(true))
